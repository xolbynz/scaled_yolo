...
def train(hyp, opt, device, tb_writer=None):
    ...
    train_path = [data_dict['train_images'], data_dict['train_labels']]
    test_path = [data_dict['val_images'], data_dict['val_labels']]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default='/local_hdd/works/ICRyu_workspace/for_yolo/weights/scaled_yolo/yolov4-p7.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='/local_hdd/works/ICRyu_workspace/for_yolo/train/scaled_yolo/challenge_subway_tracking/ch_sub_tr_v01_model.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='/local_hdd/works/ICRyu_workspace/for_yolo/train/scaled_yolo/challenge_subway_tracking/ch_sub_tr_v01_data.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='/local_hdd/works/ICRyu_workspace/for_yolo/train/scaled_yolo/challenge_subway_tracking/hyp.finetune.yaml', help='hyperparameters path, i.e. data/hyp.scratch.yaml')
    ...
    parser.add_argument('--resume', nargs='?', const='get_last', default=True,
    ...
    parser.add_argument('--name', default='ch_sub_tr_v01', help='renames results.txt to results_name.txt if supplied')
    parser.add_argument('--device', default='0', help='cuda device, i.e. 0 or 0,1,2,3 or cpu')
    # parser.add_argument('--multi_scale', action='store_true', help='vary img-size +/- 50%%')
    parser.add_argument('--multi_scale', default=True, help='vary img-size +/- 50%%')
    parser.add_argument('--single-cls', action='store_true', help='train as single-class dataset')
    parser.add_argument('--adam', action='store_true', help='use torch.optim.Adam() optimizer')
    parser.add_argument('--sync-bn', action='store_true', help='use SyncBatchNorm, only available in DDP mode')
    parser.add_argument('--local_rank', type=int, default=-1, help='DDP parameter, do not modify')
    parser.add_argument('--logdir', type=str, default='/local_hdd/works/ICRyu_workspace/for_yolo/train/scaled_yolo/challenge_subway_tracking/log/', help='logging directory')
